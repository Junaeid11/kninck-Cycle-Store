...
const HeroSection = () => {
  return (
    <div className="relative bg-slate-100 font-poppins">
      <div className="relative max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 py-16 flex flex-col-reverse lg:flex-row items-center justify-between gap-10">
        ...
        <div className="w-full lg:w-1/2 flex justify-center z-10">
          ...
          >
            <Image src={bikeImg} alt="Cycle Product" className="w-[300px] sm:w-[400px] md:w-[500px] object-contain" />
          </motion.div>
        </div>

        {/* Background Image (Visible only on large screens) */}
        <div className="absolute right-0 top-0 w-full lg:w-[55%] h-full hidden lg:block">
